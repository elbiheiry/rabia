...
@section('content')
    <div class="content">
        ...
        <div class="widget drop_zone">
            ...
            <form class="widget-content dropzone" action="{{route('admin.services.images',['id' => $id])}}" method="post" enctype="multipart/form-data" id="my-dropzone">
                {!! csrf_field() !!}
        ...
        <div class="widget">
            <div class="widget-content">
                <form method="post" action="{{route('admin.services.images.delete',['id' => $id])}}" class="ajax-form">
                    {!! csrf_field() !!}
                    <div class="col-sm-12">
                    ...
                    <div class="table-responsive">
                        @include('admin.pages.services.templates.gallery_table')
                    </div>
                </form>
            </div>
        </div>
